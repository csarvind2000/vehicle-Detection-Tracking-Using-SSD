...
# localization and detection of vehicles
...
class CarDetector(object):
    def __init__(self):
        ...
        #Single-shot-detector with mobile net architecture trained on COCO is used as pre-trained mode

        detect_model_name = 'ssd_mobilenet'
        ...
        #load tensorflow detection model and initialize the tensorflow graph
